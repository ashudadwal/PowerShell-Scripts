...
# Email configuration
$SMTPServer = "smtp.xyz.com" # Replace SMTP server
$SMTPPort = 587
$FromEmail = "xyz@gmail.com" # Replace from email
$ToEmail = "xyz@gmail.com" # Replace To email
$EmailSubject = "System Alert: Resource Threshold Exceeded"
$Password = "xxxxxxxxxxxxxxxx"  # Use your App Password if 2FA is enabled
